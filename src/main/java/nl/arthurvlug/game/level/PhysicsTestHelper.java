...
public class PhysicsTestHelper {
	...
	public static void createPhysicsTestWorld(Node rootNode, AssetManager assetManager, PhysicsSpace space) {
		...
		Material mat = assetManager.loadMaterial("assets/Materials/pebbles.j3m");
	...
	private static void makeSphere(AssetManager assetManager, Node rootNode, PhysicsSpace space, Boolean mobile) {
		...
		sphereGeometry.setMaterial((Material) assetManager.loadMaterial("assets/Materials/rock.j3m"));
	...
	private static void makeBox(AssetManager assetManager, Node rootNode, PhysicsSpace space, Boolean mobile) {
		...
		boxGeometry.setMaterial((Material) assetManager.loadMaterial("assets/Materials/bark.j3m"));
